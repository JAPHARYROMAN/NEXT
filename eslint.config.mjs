// NEXT — root ESLint flat config
// Workspaces extend this via their own eslint.config.mjs
...
export default tseslint.config(
  ...
  ...tseslint.configs.stylisticTypeChecked,
  {
    ...
    rules: {
      // Strictness — fail loudly on dangerous patterns
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message: 'Use const enums or union types instead of regular enums.',
        },
      ],
      'prefer-const': 'error',
      'no-var': 'error',
