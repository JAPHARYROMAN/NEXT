// Command server is the media-service entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/media-service/internal/api"
...
func run() error {
	...
	mediav1.RegisterMediaServiceServer(grpcSrv, api.NewMediaService(pg))
