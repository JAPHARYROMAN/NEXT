// Command server is the notification-service scaffold runtime entrypoint.
// It exposes health/readiness while domain delivery APIs are implemented.
package main
...
const (
	...
	serviceNamespace = "next-messaging"
)
