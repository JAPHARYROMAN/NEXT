// Command server is the account-recovery-service entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/account-recovery-service/internal/api"
	"github.com/next-ecosystem/next/services/account-recovery-service/internal/store"
)

const (
	serviceName      = "account-recovery-service"
...
func run() error {
	...
	accountrecoveryv1.RegisterRecoveryServiceServer(grpcSrv, api.NewRecoveryService(pg))
