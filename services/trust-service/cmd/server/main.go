// Command server is the trust-service entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/trust-service/internal/api"
	"github.com/next-ecosystem/next/services/trust-service/internal/store"
)

const (
	serviceName      = "trust-service"
	serviceNamespace = "next-trust-safety"
)
...
func run() error {
	...
	trustv1.RegisterTrustServiceServer(grpcSrv, api.NewTrustService(pg))
