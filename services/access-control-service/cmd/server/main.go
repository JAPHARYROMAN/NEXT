// Command server is the access-control-service entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/access-control-service/internal/api"
...
func run() error {
	...
	accesscontrolv1.RegisterAuthzServiceServer(grpcSrv, api.NewAuthzService(pg))
