// Command server is the media-processing-orchestrator entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/media-processing-orchestrator/internal/api"
	"github.com/next-ecosystem/next/services/media-processing-orchestrator/internal/store"
)

const (
	serviceName      = "media-processing-orchestrator"
...
func run() error {
	...
	orchestratorv1.RegisterOrchestratorServiceServer(grpcSrv, api.NewOrchestratorService(pg))
