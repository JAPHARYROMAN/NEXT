// Command server is the community-service scaffold runtime entrypoint.
// It exposes health/readiness while community APIs are implemented.
package main
