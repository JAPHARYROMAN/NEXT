// Command server is the creator-identity-service entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/creator-identity-service/internal/api"
	"github.com/next-ecosystem/next/services/creator-identity-service/internal/store"
)

const (
	serviceName      = "creator-identity-service"
...
func run() error {
	...
	creatoridentityv1.RegisterCreatorServiceServer(grpcSrv, api.NewCreatorService(pg))
