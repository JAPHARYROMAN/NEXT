// Command server is the device-graph-service entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/device-graph-service/internal/api"
	"github.com/next-ecosystem/next/services/device-graph-service/internal/store"
)

const (
	serviceName      = "device-graph-service"
...
func run() error {
	...
	devicegraphv1.RegisterDeviceServiceServer(grpcSrv, api.NewDeviceService(pg))
