// Command server is the recommendation-service entrypoint. It hosts the
// four-stage discovery funnel behind gRPC + HTTP health endpoints.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/recommendation-service/internal/api"
	"github.com/next-ecosystem/next/services/recommendation-service/internal/store"
)

const (
	serviceName      = "recommendation-service"
	serviceNamespace = "next-discovery"
)
...
func run() error {
	...
	recommendationv1.RegisterRecommendationServiceServer(grpcSrv, api.NewRecommendationService(pg))
	...
	r.Get("/readyz", func(w http.ResponseWriter, req *http.Request) {
		...
		if err := pg.Ping(req.Context()); err != nil {
