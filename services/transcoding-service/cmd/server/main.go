// Command server is the transcoding-service entrypoint.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/transcoding-service/internal/api"
...
func run() error {
	...
	transcodingv1.RegisterTranscodingServiceServer(grpcSrv, api.NewTranscodingService(pg))
