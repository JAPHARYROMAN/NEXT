// Command server is the payment-service scaffold runtime entrypoint.
// It exposes health/readiness while payment APIs are implemented.
package main
