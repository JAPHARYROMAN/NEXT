// Command server is the feed-service entrypoint. It hosts feed orchestration
// behind gRPC + HTTP health endpoints.
package main
...
import (
	...
	"github.com/next-ecosystem/next/services/feed-service/internal/api"
...
func run() error {
	...
	feedv1.RegisterFeedServiceServer(grpcSrv, api.NewFeedService(pg))
