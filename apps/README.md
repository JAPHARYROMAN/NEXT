...
| [`studio-media-console`](studio-media-console) | Browser (creators)      | Video library + processing cockpit      |
| [`live-control-room`](live-control-room)       | Browser (operators)     | Live broadcast control room             |
